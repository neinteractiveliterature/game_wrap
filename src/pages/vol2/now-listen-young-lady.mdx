...
columns: false
---
import Vol2Layout from '../../layouts/Vol2Layout.astro'

<Vol2Layout>
  <header slot="pre-content" class='article-header' style='position: relative;'>
    <img src="/vol2/images/now-listen-young-lady-faces.png" />
    <div style='position: absolute; bottom: 1%; width: 100%;'>
      <div class='article-title'>
        <h2 class='text-uppercase' style='text-shadow: 0 0 2px white;'>
          Now <br/>
          Listen <br/>
          Young Lady!
        </h2>
